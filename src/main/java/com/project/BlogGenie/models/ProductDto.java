...
public class ProductDto {
    ...
    public @Size(min = 10, message = "The description should be atleast 10 characters.") @Size(max = 2000, message = "The description cannot exceed 2000 characters.") String getDescription() {
        return description;
    }

    public void setDescription(@Size(min = 10, message = "The description should be atleast 10 characters.") @Size(max = 2000, message = "The description cannot exceed 2000 characters.") String description) {
